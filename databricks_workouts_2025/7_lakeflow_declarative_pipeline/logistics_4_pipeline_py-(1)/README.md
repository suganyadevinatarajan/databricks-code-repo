# logistics_4_pipeline_py

This folder defines all source code for the 'logistics_4_pipeline_py' pipeline:
...
* Take a look at the sample under "sample_users_logistics_4_pipeline_py.py" to get familiar with the syntax.
