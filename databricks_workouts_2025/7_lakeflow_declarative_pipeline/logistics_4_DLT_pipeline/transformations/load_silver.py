...
def silver_staff_dlt2():
    return (
        spark.readStream.table("catalog1_we4.schema1_we4.bronze_staff_data1")
        .select(
...
def silver_geotag_dlt2():
    return (
        spark.readStream.table("catalog1_we4.schema1_we4.bronze_geotag_data1")
        .select(
...
def silver_shipments_dlt2():
    ...
    return (
        spark.readStream.table("catalog1_we4.schema1_we4.bronze_shipments_data1")
