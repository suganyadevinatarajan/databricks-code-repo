...
def gold_staff_geo_enriched_dlt2():
    ...
    df_staff = spark.read.table("catalog1_we4.schema1_we4.silver_staff_dlt2")
    df_geo = spark.read.table("catalog1_we4.schema1_we4.silver_geotag_dlt2")
...
def gold_shipment_stats2():
    return (
        spark.read.table("catalog1_we4.schema1_we4.silver_shipments_dlt2")
        .groupBy("source_city")
        .agg(
